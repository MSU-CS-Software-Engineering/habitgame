...
class Shop():
    def __init__(self, shop_plugin_frame):
        ...
        # component items
        self.items.append(Item('motherboard', 'mobo.png', Type.component, "motherboard description", 200, 0, 0))
        self.items.append(Item('ram 16gb', 'ramred.png', Type.component, "ram 16gb description", 150, 0, 1))
        self.items.append(Item('ram 8gb', 'ramgreen.png', Type.component, "ram 8gb description", 75, 0, 2))
        self.items.append(Item('cpu fan', 'cpufan.png', Type.component, "cpu fan description", 50, 0, 3))
        self.items.append(Item('cpu 3.5 Ghz', 'cpu.png', Type.component, "cpu 3.5 Ghz description", 300, 1, 0))
        self.items.append(Item('gpu 2gb', 'gpured.png', Type.component, "gpu 2gb description", 300, 1, 1))
        self.items.append(Item('gpu 1gb', 'gpugreen.png', Type.component, "gpu 1gb description", 150, 1, 2))

        # hardware items
        self.items.append(Item('laptop', 'laptop.png', Type.hardware, "laptop description", 1250, 2, 0))
        self.items.append(Item('desktop', 'desktop.png', Type.hardware, "desktop description", 2000, 2, 1))
        self.items.append(Item('terminal', 'terminal.png', Type.hardware, "terminal description", 10000, 2, 2))
        self.items.append(Item('server', 'server.png', Type.hardware, "server description", 5000, 2, 3))
        self.items.append(Item('desk', 'desk.png', Type.hardware, "desk description", 500, 3, 0))
        
        # food items
        self.items.append(Item('cake', 'cake.png', Type.food, "cake description", 15, 4, 0))
        self.items.append(Item('chicken', 'chicken.png', Type.food, "chicken description", 10, 4, 1))
        self.items.append(Item('pizza', 'pizza.png', Type.food, "pizza description", 20, 4, 2))
        self.items.append(Item('soda', 'soda.png', Type.food, "soda description", 30, 4, 3))
        self.items.append(Item('popcorn', 'popcorn.png', Type.food, "popcorn description", 5, 5, 0))

        # miscellaneous items
        self.items.append(Item('gold coins', 'goldcoins.png', Type.money, "gold coins description", 50000, 6, 0))
        self.items.append(Item('change', 'change.png', Type.money, "change description", 50, 6, 1))
        self.items.append(Item('dollars', 'dollars.png', Type.money, "dollars description", 500, 6, 2))
        self.items.append(Item('money bag', 'moneybag.png', Type.money, "money bag description", 2000, 6, 3))
        ...
        self.itemSelect = Label(shop_plugin_frame, text='name')
        self.itemSelect.grid(sticky='news', row=1, columnspan=2)

        # selected item's description
        self.descriptSelect = Label(shop_plugin_frame, text='description')
        self.descriptSelect.grid(sticky='news', row=2, columnspan=2)

        # selected item's cost
        self.costSelect = Label(shop_plugin_frame, text='cost')
        ...
        buy.bind('<Enter>', lambda e: self.style.configure('buy.TLabel', background='#B3DA78'))
        buy.bind('<Leave>', lambda e: self.style.configure('buy.TLabel', background='#9FD057'))
        self.style.configure('buy.TLabel', background='#9FD057', font='arial 12 bold')
